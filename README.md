...
## OHG Action Invoice Scanner Instructions
...
Please delete the end of the path which says Invoice_scanner_Windows. The address will be extracted to will look like the below example, with Administrator replaced with your username
...
Click New and then navigate to the following directory Desktop\Invoice_scanner_Windows\poppler-20.01.0\Library\bin
